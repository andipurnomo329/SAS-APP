<div class="modal fade" id="detaildatasiswa" tabindex="-1" aria-labelledby="detaildatasiswaLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered custom-modal-position-lg">
        <div class="modal-content bg-white">
            <div class="modal-header">
                <h5 class="modal-title" id="detaildatasiswaLabel">Detail Data Siswa</h5>
