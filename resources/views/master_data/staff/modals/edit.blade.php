<div class="modal fade" id="editdatastaff" tabindex="-1" aria-labelledby="editdatastaffLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered custom-modal-position-sm">
        <div class="modal-content bg-white">
            <!-- Modal Header -->
            <div class="modal-header">
                <h5 class="modal-title" id="editdatastaffLabel">Edit Data</h5>
            ...
            <div class="modal-body">
                ...
                <form id="editFormStaff" method="post" action="{{ route ('master-data.kelas') }}" novalidate>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="kode_mapel" name="namaGuru" placeholder="Nip"
                            required value="99900">
                    </div>
                    <div class="mb-3">
                        <label for="tingkat" class="form-label">Nama Lengkap : <span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="nama_mapel" name="tingkat" placeholder="Nama Lengkap"
                            required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="tingkat" class="form-label">Jabatan : <span
                                class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        <label for="tingkat" class="form-label">Nomor Telepon : <span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="nama_mapel" name="tingkat" placeholder="nomor telepon"
                            required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="tingkat" class="form-label">Alamat : <span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="nama_mapel" name="tingkat" placeholder="Alamat"
                            required>
                    </div>
                    <div class="mb-3">
                        <label for="tingkat" class="form-label">Status : <span
                                class="text-danger">*</span></label>
                       <select class="form-select">
